...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Boost Sales'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '771441c2575b58eb19d749be4c7f9132'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '75d22e3d7e71407a108f901f588d2bd0'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_themes,read_themes,write_script_tags,read_orders,read_customers'),
    ...
    */
    ...
    'demo_customer_last_name' => env('DEMO_CUSTOMER_LAST_NAME', 'johnny'),
    'demo_customer_first_name' => env('DEMO_CUSTOMER_FIRST_NAME', 'johnny'),
    'demo_customer_address' => env('DEMO_CUSTOMER_ADDRESS', 'London'),
    'demo_customer_country' => env('DEMO_CUSTOMER_COUNTRY', 'england'),
];
